...
# Files
## Sources
- [src/module-synccast.c](src/module-synccast.c)
    The module source.
...
- [instfiles/load_pw_modules.sh](instfiles/load_pw_modules.sh)
    ...
    module on synccast connections.
- [instfiles/pipewire-synccast.desktop.in](instfiles/pipewire-synccast.desktop.in)
